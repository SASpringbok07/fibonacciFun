...
export function fibPopulate(limit){
    let num = 0;
    let fibNums = [];
    while(fib(num, fibNums) < limit){
        num++;
    }
...
export function fib(num, fibNums){
    fibNums = fibNums || {};
    ...
    return fibNums[num] = fib(num - 1, fibNums) + fib(num - 2, fibNums);

}

export function fibEvenSum(fibNums){
    fibNums = fibNums || [];
    let summation = 0, i = 0;
